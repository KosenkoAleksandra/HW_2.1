...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car(driverB1, "Lada", "Granta", 1.7, BodyType.SEDAN);
        Car car2 = new Car(driverB2, "Audi", "A8", 3.0, BodyType.SEDAN);
        Car car3 = new Car(driverB3, "BMW", "Z8", 3.0, null);
        Car car4 = new Car(driverB4, "Kia", "Rio", 1.6, BodyType.HATCHBACK);
        ...
        Bus bus1 = new Bus(driverD1, "Беларусь", "222", 3.0, BusCapacity.SMALL);
        Bus bus2 = new Bus(driverD2, "Минск", "008", 2.7, BusCapacity.AVERAGE);
        Bus bus3 = new Bus(driverD3, "Урал", "456", 2.7, BusCapacity.BIG);
        Bus bus4 = new Bus(driverD4, "Минск", "346", 3.0, BusCapacity.AVERAGE);
        ...
        Truck truck1 = new Truck(driverC1, "Man", "340n", 8.6, LoadType.N2);
        Truck truck2 = new Truck(driverC2, "Камаз", "675", 12.0, LoadType.N1);
        Truck truck3 = new Truck(driverC3, "Маз", "427", 6.7, LoadType.N3);
        Truck truck4 = new Truck(driverC4, "Белаз", "56", 7.6, LoadType.N3);
